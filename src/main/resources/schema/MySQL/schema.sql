...
CREATE TABLE sys_user(
    ...
    zone                		VARCHAR(19)    									COMMENT '所属区域',
    country_code                VARCHAR(20)    									COMMENT '所属区域（国家编码）',
    country_name                VARCHAR(255)    								COMMENT '所属区域（国家名称）',
    province_code               VARCHAR(20)    									COMMENT '所属区域（省编码）',
    province_name               VARCHAR(255)    								COMMENT '所属区域（省名称）',
    city_code                   VARCHAR(20)    									COMMENT '所属区域（市编码）',
    city_name                   VARCHAR(255)    								COMMENT '所属区域（市名称）',
    district_code               VARCHAR(20)    									COMMENT '所属区域（区县编码）',
    district_name               VARCHAR(255)    								COMMENT '所属区域（区县名称）',
    native_place_code           VARCHAR(20)    									COMMENT '籍贯（编码）',
    nation_code               	VARCHAR(20)    									COMMENT '民族（编码）',
    graduate_school           	VARCHAR(255)    								COMMENT '毕业院校',
    education_code           	VARCHAR(20)    									COMMENT '学历（编码）',
    degree_code           		VARCHAR(20)    									COMMENT '学位（编码）',
