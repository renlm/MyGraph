...
public class JedisTest {
	...
	public void zadd() {
		...
		Long reply11 = jedis.zadd(key, expTime, IdUtil.getSnowflakeNextIdStr());
		log.info("添加或更新当前uid：{}", reply11);
		Long reply2 = jedis.zremrangeByScore(key, 0, DateUtil.current());
		log.info("删除小于等于当前时间的记录：{}", reply2);
